...
- **1–5 Personen** (Eltern, Geschwister, zwei Onkel, ein Patenkind): **Basic** reicht. Max-Cap ist 5 aktive Sponsoren pro Mannschaft, max. 3 Regeln pro Sponsor.
- **6+ Personen**, oder du planst eine offene Sponsoren-Akquise (öffentliche Mannschafts-Seite, Einladungslinks im großen Stil): **Pro**. Hier hebst du den Sponsor-Cap auf, kriegst Saison-Ziele und Custom-Trigger.

**Frage 3: Brauchst du Saison-Ziele oder Custom-Trigger?**

- "200 € pro Sponsor, wenn die Erste aufsteigt" — **das geht nur in Pro und Vereinslizenz**.
...
- **Provision:** 0 % auf allen Tarifen. Du behältst 100 % der Sponsoren-Beiträge, KickPact verdient an Lizenzen.
...
Default-Regel: **Im Zweifel Pro für 30 Tage Trial testen**. Wenn du nach 30 Tagen merkst, dass nur 4 Familien-Sponsoren mitmachen und Saison-Ziele irrelevant sind, downgrade auf Basic. Andersrum funktioniert auch — Basic starten, im Trial-Fenster auf Pro wechseln, sobald der Sponsoren-Kreis wächst.
