  ...
  return (
    <article className="text-sm md:text-base leading-relaxed text-brand-night-navy/80">
      ...
      <p className="mt-2">
        ...
        DDG sind wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte
      ...
      <p className="mt-2">
        Die frühere EU-Plattform zur Online-Streitbeilegung (OS) wurde zum
        20. Juli 2025 eingestellt. Wir sind nicht bereit oder verpflichtet, an
