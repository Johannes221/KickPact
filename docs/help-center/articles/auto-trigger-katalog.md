...
Auto-Trigger sind die Trigger, die KickPact **vollautomatisch** aus Fußball.de-Daten ableitet. Kein Trainer muss klicken, keine Bestätigung nötig — passiert das Ereignis, wird der Pledge gefeuert.
...
Feuert pro Tor deiner Mannschaft, unabhängig vom Torschützen. Klassischer Pledge: **5 € pro Tor**.

- Bei 3:1-Sieg: 3 Charges
- Bei 7:1-Festspiel: 7 Charges (denk an Per-Match-Cap)

### `goal_player` — Tor eines Spielers

Feuert nur, wenn ein **bestimmter Spieler** trifft. Pflicht-Filter: `player_id`. Standardpledge der Eltern für ihren Sohn / ihre Tochter.

- Bei 3:1, Sohn schießt 2 Tore: 2 Charges
- Bei 3:1, Sohn schießt 0 Tore: 0 Charges

### `win` — Sieg

Feuert genau **einmal pro Spiel**, wenn die Mannschaft gewonnen hat (also Endstand > Gegner). Unabhängig vom Toranzahl. Beispiel-Pledge: **20 € pro Sieg**.

### `draw` und `loss` — Unentschieden / Niederlage

Analog zu `win`. Manche Sponsoren wetten gegen den Misserfolg: "10 € pro Niederlage" (= ich helfe euch trotzdem, wenn's mal schlecht läuft).

### `clean_sheet` — Zu Null

Mannschaft gewinnt oder spielt remis **ohne Gegentor**. Belohnt die Defensive. Typischer Pledge für Sponsoren, die Torwart-Eltern sind. **15 € pro Clean Sheet** ist eine gängige Größenordnung.
...
Mannschaft lag mit mindestens 2 Toren zurück und hat trotzdem gewonnen. Selten, aber emotional aufgeladen. Beispiel-Pledge: **30 € pro Comeback**.
...
Praktisch für Belohnungspledges: "Wenn ihr klar gewinnt (≥3 Tore Differenz), 25 €".
...
Klassischer "Spektakel-Pledge": "Wenn das Spiel torreich ist, 15 €".
...
- **Auswechslungen** — sind importiert, aber kein eigener Trigger (Spieler war auf Platz vs. nicht — keine Pledge-Logik)

## Wie genau ist das?

- **Tore**: bei Standard-Ligen sehr zuverlässig (>98 %). Nachträgliche Korrekturen auf Fußball.de werden vom Crawler beim nächsten Lauf übernommen — siehe [Fußball.de ändert Daten](fussballde-aendert-daten.md).
