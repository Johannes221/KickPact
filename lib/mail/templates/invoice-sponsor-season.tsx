...
export function invoiceSponsorSeasonEmail(args: {
  ...
  return {
    subject: `Deine KickPact-Saisonrechnung ${invoiceNumber} · ${period}`,
    text: `Hi ${sponsorName},

die ${period} ist vorbei — hier kommt deine Saisonrechnung: ${itemCount} Beiträge aus der ganzen Saison, Gesamt ${totalEur}.

Rechnungsnummer: ${invoiceNumber}
Mannschaft: ${clubName}

Du hast Saisonende-Abrechnung gewählt: Alle Beiträge der Saison stehen gesammelt auf dieser einen Rechnung.
  ...
  <table style="max-width: 560px; margin: 0 auto; background:#fff; border-radius:14px; padding: 40px;">
    <tr><td>
      ...
      <p style="color: #1A1A2E; margin: 0 0 16px; line-height: 1.6;">
        die <strong>${period}</strong> ist vorbei — hier kommt deine Saisonrechnung:
      ...
      <p style="color:#525252; font-size: 14px; line-height: 1.6; margin: 0 0 16px;">
        ...
        auf dieser einen Rechnung. Die PDF findest du im Anhang — bitte überweise den
        Betrag innerhalb von 14 Tagen an den Verein, die Bankverbindung steht auf der Rechnung.
      </p>
