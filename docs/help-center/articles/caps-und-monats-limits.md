...
Geblockte Tore sind sichtbar in deinem Dashboard ("4 Tore vom Per-Match-Cap geblockt"), erzeugen aber **keine Charge**.

**Faustregel:** Per-Match-Cap auf ~2-3× das "Normal-Spiel"-Niveau setzen. Bei 5 €/Tor-Pledge und durchschnittlich 2 Toren = Per-Match-Cap 15-25 €.

## Monats-Cap

Schützt deinen Monats-Geldbeutel. Praktisches Beispiel:

- Du pledgst 5 € pro Tor + 20 € pro Sieg.
- Im normalen Monat: 4 Spiele × ~2 Tore + 2 Siege = 4×10 + 40 = 80 €.
- Im **Top-Monat**: 4 Spiele × 4 Tore + 4 Siege = 4×20 + 80 = 160 €.
- Mit Monats-Cap "100 €/Monat": Bei 100 € erreichten Charges werden alle weiteren Trigger geblockt.
...
1. **Match-Event vom Crawler** (z.B. 5. Tor im 7:1-Spiel)
2. **Pledge-Regel matched** (5 € Tor-Pledge)
3. **Per-Match-Cap geprüft:** schon ≥20 € in diesem Spiel? → Charge geblockt.
4. **Monats-Cap geprüft:** mit dieser Charge ≥100 €? → Charge geblockt.
5. **Saison-Cap geprüft:** mit dieser Charge ≥600 €? → Charge geblockt.
6. Wenn alle Checks pass: **Charge erzeugt**.

Wichtig: Caps werden **monoton** geprüft. Sobald ein Cap erreicht ist, gibt's keinen Charge mehr für den restlichen Cap-Zeitraum. Es wird **nicht** anteilig oder fair zwischen Triggern verteilt — first come, first served.

## Was im Sponsor-Dashboard sichtbar ist

- **Diese Woche:** Charges + geblockte Trigger
...
## Pledge-Beispiel mit allen drei Caps

Pledge "Familien-Pledge für FC Musterstadt Herren":
...
- Siege: 4 × 10 € = 40 €
- Aber Monats-Cap 100 €: Charge-Stop nach ~14. erfolgreichen Trigger.
...
- Cap **gesenkt**: gilt sofort. Bereits erzeugte Charges bleiben — du zahlst, was schon angefallen ist.
