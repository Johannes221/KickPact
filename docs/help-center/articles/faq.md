...
category_label: "FAQ"
prio: "MUSS"
audience: ["verein-admin", "sponsor", "trainer", "vereinslizenz-admin"]
related_articles:
  - "welcher-tarif-passt"
  - "was-ist-ein-pledge"
  - "trial-30-tage"
...
**Ja.** Ein KickPact-Account kann Admin-Rechte für **mehrere Vereine** haben. Du wählst beim Login, welchen Verein du gerade verwaltest. Das ist nicht Vereinslizenz (ein Verein, viele Mannschaften), sondern Multi-Tenant-Setup.

## 4. Bekommt KickPact Provision?

**Nein.** KickPact verdient ausschließlich an **Lizenzen** (Basic, Pro, Vereinslizenz). 0 % Provision auf Sponsor-Zahlungen. Was zwischen Sponsor und Verein fließt, fließt direkt — KickPact ist nur das Tracking-System.
...
Mehr in [Kündigung und Pause](kuendigung-und-pause.md).
...
**Teilweise.** Du kannst eine Mannschaft als "Manual-Only" anlegen, dann musst du alle Spiele und Ergebnisse selbst eintragen. Auto-Trigger funktionieren dann nicht automatisch — nur was du manuell eingibst. Pragmatisch nur sinnvoll für Vereine, die **gar nicht** auf Fußball.de sind (sehr selten).
...
**Aktuell nur Fußball.** Der Crawler ist auf Fußball.de spezialisiert, die Trigger sind fußballspezifisch (Tor, Hattrick, etc.). Wir denken über Handball / Hockey nach, aber das ist in v1 nicht drin.

## 15. Was wenn ich Pro abonniert habe und kein Sponsor zustandekommt?

Du zahlst trotzdem die Lizenz, auch wenn 0 Sponsoren aktiv sind. KickPact ist kein Performance-basiertes Tool für die Verein-Seite — du zahlst für die Plattform, unabhängig von Auslastung.
