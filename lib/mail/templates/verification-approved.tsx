export function verificationApprovedEmail(args: {
  ...
  return {
    ...
    text: `Hi,\n\n${clubName} ist verifiziert und vollständig freigeschaltet. Sponsoren können jetzt ohne Banner ihre Pacts anlegen und Zahlungsübersichten gehen automatisch raus.${invoiceLine}\n\nDashboard: ${dashboardUrl}\n\n— KickPact`,
    html: `<!doctype html>
<html><body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Inter, sans-serif; background:#fafafa; padding: 40px 20px;">
  <table style="max-width: 520px; margin: 0 auto; background:#fff; border-radius:12px; padding: 40px;">
    <tr><td>
      ...
      <p style="color: #525252; margin: 0 0 16px;">Dein Verein ist verifiziert und vollständig aktiv. Sponsoren können jetzt ohne Hinweis ihre Pacts anlegen, Zahlungsübersichten gehen automatisch raus.</p>
      ${invoiceHtml}
