...
export const metadata = { title: "Zahlungsübersichten · KickPact" };
    ...
    return (
      <div className="mx-auto max-w-3xl">
        <div className="mb-6 md:mb-10">
          <PageHeader className="md:hidden" title="Zahlungsübersichten" />
        ...
        <div className="rounded-lg border border-brand-neutral/40 bg-brand-off-white p-6 md:p-8">
          <p className="text-sm md:text-base text-brand-night-navy/70">
            ...
            bevor Zahlungsübersichten hier erscheinen.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-6 md:mb-10">
        <PageHeader
          className="md:hidden"
          title="Deine Zahlungsübersichten"
          subtitle={
            result.total === 0
              ? "Noch keine Zahlungsübersichten — kommt zum 1. des Monats."
              : `${result.total} Zahlungsübersicht${result.total === 1 ? "" : "en"} · Diese Seite ${eur(totalCents)}`
          }
        />
      ...
      {result.total === 0 ? (
        <div className="rounded-2xl border border-brand-neutral/40 bg-brand-off-white p-6 md:p-8">
          ...
          <p className="mt-1.5 md:mt-2 text-sm text-brand-night-navy/60 max-w-md">
            ...
            kommt am 1. des Folgemonats die Zahlungsübersicht — direkt vom Verein, KickPact
